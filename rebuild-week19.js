...
async function run() {
  ...
  // SAFE OUTPUT:
  // This creates a separate Week 19 file and does NOT touch
  // the live data/weekly-leaders.json file.
  const outPath = path.join(__dirname, "data", "week19-rebuilt.json");
